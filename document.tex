...
%---------------------------------------------------------------
\section{Application}
We are now in the process of finalizing the setup of the proposed system
using a network of 4 eye trackers. Our scripts in the browser client stream the
field of view parameters of each user and their gaze coordinates to a server
situated in the robot that parses and commands the display unit of the robot to
render the gaze coordinates of each user represented as a disc over a condensed
representation of the panoramic image.
...
and how it can be used to monitor the gaze behavior of remote museum
visitors.
...
\section{Discussion}
Advancements in robotics and communitaction technologies have allowed the
...
One particular are where telepresence systems can be particularly advantegous is
for education scenarios such as the system presented in this work that allows
...
gaze data to find out those students that are not benefitting from the museum
