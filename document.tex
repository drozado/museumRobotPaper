...
where the remote students are paying attention in the guide's environment so he or she can adapt his/her behavior
accordingly.
...
The museum tour guide wears a wireless lapel microphone to ensure that he can be heard by the remote students. The
museum tour guide can see who is online and which students have questions via the display on the front of the robot.
...
being displayed on screen at any given time) from the panoramic image and the x, y coordinate of their gaze on screen.
These four parameters define the point in 3D space the student is looking at. This information is sent back to the
robot, that converts it to a 2D point in the condensed omnidirectional image.
...
This manuscript's associated video \footnote{\url{http://youtu.be/gB89jT2_3oA}} provides a good visual
overview of the system at work and how it can be used to monitor the gaze behavior of remote museum visitors. 
