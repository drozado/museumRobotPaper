...
\begin{figure}[tp]
 ...
 wrapped onto a virtual sphere to create an immersive 3D-like experience for the remote users. The planes in the top of
 the Figure represent the planes captured by the different cameras in the Ladybug. The color coded representation in
 the bottom display how the different planes are stiched together in the panoramic viewer to form a cubical panoramic
 environment.}
...
\begin{center}
 ...
 environment around the robot (top image). Individual users can look at different planes of the
